# CSE 11 Spring 2023 PA7 - Critter and Inheritance
**Due date: Thursday, June 1st @11:59PM PDT**

There is an **[FAQ post](https://piazza.com/class/lfx8rc63u25xd/post/278)** on Piazza. Please read that post first if you have any questions.
...
## Overview
Critter [Gradescope, 100 points, up to 105 points]
...
Create a file called `CustomCritter.java` for your own Critter. Your Critter must have at a **minimum**, its:
* own display name (must be appropriate)
...
## Submission & Grading
Submit the following file to Gradescope by **Thursday, June 1st @ 11:59PM PDT**.
...
* **Extra Credit** [5 points]
    * There will be no resubmission for the extra credit portion.
